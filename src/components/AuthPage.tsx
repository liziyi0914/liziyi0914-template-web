...
> = (props) => {
  ...
  return (
    <div className="h-screen bg-blue-200 dark:bg-blue-950">
      ...
      <div className="h-[calc(100vh-12rem)] md:h-screen md:flex justify-center items-center">
        <div className="bg-card md:pb-4 pt-6 h-full md:h-auto md:mb-48 rounded-t-2xl md:rounded-2xl overflow-hidden shadow-lg">
